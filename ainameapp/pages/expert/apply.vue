...
<style scoped>
.apply-page{min-height:100%;color:#111827}.page-head{display:flex;justify-content:space-between;align-items:center;gap:24rpx;margin-bottom:28rpx}.page-title{font-size:44rpx;font-weight:800}.panel{background:#fff;border:1px solid #e5e7eb;border-radius:8px;padding:36rpx;margin-bottom:28rpx}.login-panel{text-align:center;padding:100rpx 30rpx}.muted{display:block;color:#6b7280;font-size:25rpx;line-height:1.6;margin-top:8rpx}.status-title{font-size:34rpx;font-weight:800;margin-bottom:22rpx}.readonly-row{display:flex;justify-content:space-between;gap:24rpx;padding:18rpx 0;border-bottom:1px solid #eef2f7;color:#6b7280}.readonly-row text:last-child{color:#111827;text-align:right}.readonly-block{padding:20rpx 0;border-bottom:1px solid #eef2f7}.readonly-block>text{display:block;color:#6b7280;margin-bottom:10rpx}.readonly-block>view{line-height:1.7}.status-copy{margin-top:24rpx}.field-label{font-size:26rpx;color:#4b5563;font-weight:700;margin:20rpx 0 10rpx}.form-input,.form-area{width:100%;box-sizing:border-box;border:1px solid #d1d5db;background:#fff;border-radius:8px;font-size:28rpx;color:#111827}.form-input{height:88rpx;padding:0 22rpx}.picker{display:flex;align-items:center}.form-area{height:160rpx;padding:22rpx;line-height:1.6}.form-area.large{height:220rpx}.primary{background:#2563eb;color:#fff;border-radius:8px;margin-top:28rpx}.outline-btn{margin:0;background:#fff;color:#4b5563;border:1px solid #d1d5db;border-radius:8px}.reject-note{background:#fee2e2;color:#dc2626;padding:22rpx;border-radius:8px;margin-bottom:24rpx}@media(max-width:768px){.page-head{align-items:flex-start;flex-direction:column}.outline-btn{width:100%}}
</style>
